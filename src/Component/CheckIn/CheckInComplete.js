...
import sbi from "../Homepage/sbi.jpg"
import hdfc from "../Homepage/hdfc.png"
import icici from "../Homepage/icici.png"
            ...
            <div className="Adverts mt5">
                    ...
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            <div class="flip-card-front">
                                <img src={loyalty} alt="Avatar" style={{ "width": "100%", "height": "100%", }} />
                            </div>
                ...
                <div class="row2 fl w-50-ns w-25-l pr2 tc ">
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            <div class="flip-card-front">
                                <img src={icici} alt="Avatar" style={{ "width": "100%", "height": "100%", }} />
                            </div>
                            <div class="flip-card-back">
                                <p>BROWNFIELD PROVIDES THE BEST PRICES IN THE
                                    MARKET THAT MAKES YOUR JOURNEY BOTH ENJOYABLE
                ...
                <div class="row2 fl w-50-ns w-25-l pr2 tc">
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            <div class="flip-card-front">
                                <img src={hdfc} alt="Avatar" style={{ "width": "100%", "height": "100%", }} />
                            </div>
                            <div class="flip-card-back">
                                <p>BROWNFIELD PROVIDES THE BEST PRICES IN THE
                                    MARKET THAT MAKES YOUR JOURNEY BOTH ENJOYABLE
                ...
                <div class="row2 fl w-50-ns w-25-l tc ">
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            <div class="flip-card-front">
                                <img src={sbi} alt="Avatar" style={{ "width": "100%", "height": "100%", }} />
                            </div>
                            <div class="flip-card-back">
                                <p>BROWNFIELD PROVIDES THE BEST PRICES IN THE
                                    MARKET THAT MAKES YOUR JOURNEY BOTH ENJOYABLE
